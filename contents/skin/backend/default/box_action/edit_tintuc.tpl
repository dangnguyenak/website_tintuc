    ...
    <div class="khung_post">
        ...
        <form action='cpanel_process.php?action=edit_tintuc' enctype="multipart/form-data" method="post">
            ...
            <div class="li">
                ...
                <div class="noi_dung">
                    <input name='minh_hoa' value="" type="file" placeholder="Nhập tiêu đề">
                </div>
            </div>
            <div class="li">
                <div class="tieu_de">Nội dung</div>
                <div class="noi_dung"><textarea required name='noi_dung' id='ckeditor'
                                                class="ckeditor">{noi_dung}</textarea>
                </div>
            </div>
    </div>
