...
//////////////////////////////////////////////
$('input[name=duyet]').live('click', function () {
    value = $(this).val();
    id = $(this).attr("post");
    if (value == 0) {
        $(this).attr("value", "1");
...
$('input[name=duyet_cmt]').live('click', function () {
    value = $(this).val();
    id = $(this).attr("post");
    if (value == 0) {
        $(this).attr("value", "1");
    ...
    $.ajax({
        url: "process.php?action=duyet_cmt&id=" + id + "&value=" + value,
        type: "post",
        success: function (kq) {
        }
...
//////////////////////////////////////////////
$('input[name=hot]').live('click', function () {
    value = $(this).val();
    id = $(this).attr("post");
    if (value == 0) {
        $(this).attr("value", "1");
...
$(".loai_tailieu").live('click', function () {
...
$(".loai_download").live('click', function () {
...
$('select[name=noidung_timkiem]').live('change', function () {
...
$('select[name=kieu_timkiem]').live('change', function () {
...
$(".button_timkiem").live('click', function () {
...
$("input[name=keywords]").live('keypress', function (e) {
