(function (o, i, k) {
    ...
    i.infinitescroll.prototype = {
        _binding: function g(F) {
            ...
            var D = this.options, J = this.options.callback,
                L = (D.state.isDone) ? "done" : (!D.appendCallback) ? "no-append" : "append", K;
            ...
            if (D.animate) {
                ...
                i("html,body").animate({scrollTop: I}, 800, function () {
            ...
            D.loading.msg.find("img").hide().parent().find("div").html(D.loading.finishedMsg).animate({opacity: 1}, 2000, function () {
            ...
            switch (K) {
                ...
                case"html":
                    ...
                    i.ajax({
                        url: D, dataType: G.dataType, complete: function H(L, M) {
                ...
                case"json":
                    E._debug("Using " + (K.toUpperCase()) + " via $.ajax() method");
                    i.ajax({
                        dataType: "json", type: "GET", url: D, success: function (N, O, M) {
