    ...
    $(document).ready(function () {
        $(window).scroll(function () {
            if ($(window).scrollTop() >= $(document).height() - $(window).height()) {
                ...
                user_id = $('#infscr-loading').attr("user");
                if (page == 0) {
                    ...
                    $.ajax({
                        url: "process.php?action=load_mempost&id=" + user_id + "&page=" + page + "&limit=" + limit,
                        type: "post",
                        success: function (kq) {
                            if (kq == 0) {
    ...
    <div class="content">
        ...
        <div class="i-category fl">
            ...
            <div id="content" class="icat clearfix">
                ...
                <div id="infscr-loading" style="display:none;" page="1" user='{userid}' limit="{limit}">
