...
class class_check extends manage
{
...
//////////////////////////////////////////////////////////////////
    function del_link($noi_dung)
    {
        $i = 0;
        $patt = '/<a(.*)>(.*)<\/a>/i';
        if (preg_match_all($patt, $noi_dung, $ms)) {
            foreach ($ms[1] as $link) {
                $noi_dung = str_replace($link, '', $noi_dung);
                $noi_dung = str_replace('<a>', '', $noi_dung);
                $noi_dung = str_replace('</a>', '', $noi_dung);
                $noi_dung = str_replace('<h2>', '<b>', $noi_dung);
                $noi_dung = str_replace('</h2>', '</b>', $noi_dung);
                $noi_dung = str_replace('(Kênh 13)', '(Tinvietnam24h)', $noi_dung);
                $noi_dung = str_replace('<div class="article-more test" style="margin: 15px 0px; clear: both;">', '<div class="article-more test" style="display:none;margin: 15px 0px; clear: both;">', $noi_dung);
                $noi_dung = str_replace('<ul class="tinmoi">', '<br><ul class="tinmoi" style="display:none;">', $noi_dung);
